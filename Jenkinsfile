pipeline {
    ...
    stages {
        ...
        stage("Docker build backend") {
            steps {
                withCredentials([usernamePassword(credentialsId: '478ecc63-3740-42aa-9fe8-15a099d43a63', usernameVariable: 'Ahmedbachirmejri', passwordVariable: 'DOCKER_HUB_PASSWORD')]) {
